        ...
        >
          ...
          <FirstNewsHeadline
            ...
            newsHandler={async () => {
              ...
              router.replace(
                `/details?read=${firstHeadline?.read}&category=${firstHeadline?.category}&image=${firstHeadline?.image}&title=${firstHeadline?.title}&time=${firstHeadline?.time}`
              );
            }}
          />
          <Text
            ...
            {data.map((item, idx) => {
              return (
                <NewsHeadlineCard
                  ...
                  newsHandler={async () => {
                    router.replace(
                      `/details?read=${item?.read}&category=${item?.category}&image=${item?.image}&title=${item?.title}&time=${item?.time}`
                    );
                  }}
                />
              );
